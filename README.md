...
```bash
curl -X POST "http://localhost:8081/floors" \
...
curl -X POST "http://localhost:8081/slots" \
-H "Content-Type: application/json" \
-d '{
  "slotNumber": 101,
  "floorId": 1,
...
curl -X GET "http://localhost:8081/reservations/availability?startTime=2025-10-01T10:00:00&endTime=2025-10-01T12:00:00"
```
...
curl -X POST "http://localhost:8081/reservations/reserve" \
-H "Content-Type: application/json" \
-d '{
  "slotId": 1,
...
curl -X GET "http://localhost:8081/reservations/1"
```
